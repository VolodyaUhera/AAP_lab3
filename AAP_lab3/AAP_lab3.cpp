...
void headertask1() 
{
    printf("Ëàáîðàòîðíà ðîáîòà ¹3");
    printf("Çàâäàííÿ 1. Ïðîãðàìà äëÿ çíàõîäæåííÿ c[i][j] = c[j][i] ");
    printf("òà çíàéòè ¿õ ê³ëüê³ñòü");
}
...
{
    printf("Ëàáîðàòîðíà ðîáîòà ¹3");
    printf("Çàâäàííÿ 2. Âèâåñòè íîìåð³ ñòîâïö³â äå âñ³ åëåìåíòè äîäàòí³");
    printf("òà ðÿäêè äå âñ³ åëåìåíòè â³äºìí³");
}
